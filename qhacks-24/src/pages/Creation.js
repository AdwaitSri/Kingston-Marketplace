...
export default function Creation() {
    ...
    const createListing = async (imageUrl) => {
    ...
    const [category, setCategory] = React.useState(
      ...
      // ! IMPORTANT ! CHANGE TO THE USER'S NAME AFTERWARDS
    ...
    function handleSellerChange(event) {
        setSeller(prevSeller => {
            let newSeller = prevSeller;
            if (event.target.value.length <= 50) {
                newSeller = event.target.value;
            }
            return newSeller;
        });
    }
        ...
        <div className="w-4/5 mx-auto">
            <div className="mt-[20px] mx-auto px-4">
                ...
                <form>
                    ...
                    <div className="mb-4 flex justify-between">
                    <label className="font-jose block" htmlFor="title">
                        <p className="text-gray-700 text-sm font-semibold">Seller Name</p>
                        <p className="text-[#aaaaaa] text-[10px]">(max 50 characters)</p>
                    </label>
                    <input
                        className="font-jose shadow appearance-none border-2 w-[80%] py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    ...
                    <label className="font-jose block text-gray-700 text-sm font-bold mb-2">
                        ...
                        >
                            <input className='font-jose w-full py-8 px-3 text-gray-700 text-[24px] border-2 border-dotted border-[#aaaaaa] z-10' type="file" onChange={(event)=>{setImageUpLoad(event.target.files[0])}}></input>
                    ...
                    <div className="flex justify-between">
                        ...
                        >
                            ...
                            <div className='h-full w-full p-[10px] relative'>
                                ...
                                <p className="font-jose text-[12px] relative top-[-3px] tracking-tight">Seller: {seller}</p>
