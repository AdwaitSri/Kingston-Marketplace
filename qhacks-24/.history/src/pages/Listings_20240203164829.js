    ...
    return (
        ...
        >
            ...
            >
                ...
                <div>
                    <h1 className="font-jose ml-[40px] text-[#aaaaaa]">Entertainment</h1>
                    <h1 className="font-jose ml-[40px] text-[#aaaaaa]">Kitchenware</h1>
                    <h1 className="font-jose ml-[40px] text-[#aaaaaa]">Furniture</h1>
                    <h1 className="font-jose ml-[40px] text-[#aaaaaa]">Electronics</h1>
                    <h1 className="font-jose ml-[40px] text-[#aaaaaa]">Other</h1>
                </div>
