    ...
    return (
        ...
        >
            ...
            >
                ...
                <div>
                    <h1 className="font-jose ml-[40px]">Furniture</h1>
                    <h1 className="font-jose ml-[40px]">Electronics</h1>
                    <h1 className="font-jose ml-[40px]">Kitchenware</h1>
                    <h1 className="font-jose ml-[40px]">Entertainment</h1>
                    <h1 className="font-jose ml-[40px]">Other</h1>
                </div>
