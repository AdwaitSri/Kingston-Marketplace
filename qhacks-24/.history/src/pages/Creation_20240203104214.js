            ...
            <div className="mt-[20px] mx-auto px-4">
                ...
                <form>
                    ...
                    <div className="mt-2 w-[80%]">
                        ...
                        <input type="radio" className="form-radio" name="condition" value="Brand New" onChange={handleConditionChange} />
                        <span className="font-jose ml-2">Brand New</span>
                        </label>
                        <label className="font-jose inline-flex items-center ml-6">
                        <input type="radio" className="form-radio" name="condition" value="Like New" onChange={handleConditionChange} />
                        <span className="font-jose ml-2">Like New</span>
                        </label>
                        <label className="font-jose inline-flex items-center ml-6">
                        <input type="radio" className="form-radio" name="condition" value="Lightly Used" onChange={handleConditionChange} />
                        <span className="font-jose ml-2">Lightly Used</span>
                        </label>
                        <label className="font-jose inline-flex items-center ml-6">
                        <input type="radio" className="form-radio" name="condition" value="Used" onChange={handleConditionChange} />
                    ...
                    <div className="flex justify-between">
                        ...
                        >
                            ...
                            <div className='h-full w-[80%] p-[10px]'>
                                <p className="font-jose font-bold tracking-tight">{title}</p>
                            </div>
                        </div>
                    </div>
