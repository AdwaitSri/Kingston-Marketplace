            ...
            >
                <div className=" mx-[20px]">
                    <form className="w-full flex">
                        <input 
                            className="border-2 border-black border-solid rounded-2xl w-[60%] p-2"
                            type="text" 
                            name="search" 
                            placeholder="Type your search here"
                        />
                        <button type="submit" value="Search" className="border-2 border-solid border-black rounded-2xl px-[50px]">Search</button>
                    </form>
                </div>
