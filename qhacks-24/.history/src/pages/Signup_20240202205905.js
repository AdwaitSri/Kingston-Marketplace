...
export default function Signup() {
    ...
    class="w-full bg-orange-1 rounded-lg shadow dark:border md:mt-[10dvh] sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700 mx-auto mt-[10dvh]">
        ...
        <form class="space-y-4 md:space-y-6" method="POST">
            ...
            <button type="submit" class="w-full  bg-[#000000] border-[#000000] border-2 border-solid font-medium rounded-lg text-sm px-5 py-2.5 text-center">Create an account</button>
