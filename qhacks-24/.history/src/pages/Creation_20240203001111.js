            ...
            <div className="mt-[20px] mx-auto px-4">
                ...
                <form>
                    ...
                    <label className="font-jose block text-gray-700 text-sm font-bold mb-2">
                        ...
                        <div
                            className='w-[80%] p-[5px] border-2 border-solid border-black bg-[#cccccc]'
                        >
                            <button
                                type="button"
                                className="font-jose w-full py-8 px-3 text-gray-700 text-[24px] border-2 border-dotted border-[#aaaaaa] bg-[#ffffff] z-10"
                            >
                                + Upload An Image
                            </button>
                        </div>
