...
export default function Signup() {
    ...
    class="w-full rounded-lg bg-orange-1 shadow dark:border md:mt-[10dvh] sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700 mx-auto mt-[10dvh]">
        ...
        <form class="space-y-4 md:space-y-6" method="POST">
            ...
            <div className="bg-dark-1 w-full z-10 font-medium rounded-lg text-sm px-5 py-2.5 text-center"><button type="submit" className="text-[#ffffff]">Create an account</button></div>
